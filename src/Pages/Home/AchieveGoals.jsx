  ...
  <div className="max-w-6xl mx-auto">
    ...
    >
      ...
      <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
        Managing money isn't just about numbers. It's about building the future
        you dream of, one step at a time.
      </p>
    </motion.div>
    ...
    >
      {/* Card 1  */}
      <motion.div
        className="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 transition-colors duration-500"
        variants={cardVariants}
      >
        <FaMoneyBillWave className="text-4xl text-indigo-500 dark:text-indigo-400 mb-5" />
      ...
      <motion.div
        ...
        variants={cardVariants}
      >
        <FaChartLine className="text-4xl text-green-500 dark:text-green-400 mb-5" />
        <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-3">
          See Your Growth
        </h3>
        <p className="text-gray-600 dark:text-gray-400">
      ...
      <motion.div
        ...
        variants={cardVariants}
      >
        <FaTrophy className="text-4xl text-yellow-500 dark:text-yellow-400 mb-5" />
        <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-3">
          Achieve Milestones
        </h3>
        <p className="text-gray-600 dark:text-gray-400">
