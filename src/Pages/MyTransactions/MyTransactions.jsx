...
const MyTransactions = () => {
  ...
  return (
    <div className="min-h-screen max-w-7xl mx-auto px-4 py-10  text-gray-300">
      <h2 className="text-3xl font-bold mb-8 text-center text-indigo-400">
        My Transactions
      </h2>

      {transactions.length === 0 ? (
        <div className="text-center text-gray-400 text-lg p-10 bg-gray-900 rounded-lg shadow-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {transactions.map((transaction) => (
            <div
              key={transaction._id}
              className={`bg-gray-900 rounded-lg shadow-lg flex flex-col justify-between transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 border-b-4 ${
            ...
            >
              ...
              <div className="flex justify-end items-center gap-5 border-t border-gray-800 bg-gray-900 px-5 py-1.5 rounded-b-lg">
                <Link
